...
In that case withdrawal [account](../from_ever_to_solana_with_solana_tokens.md#withdraw-account) can have only three states: new, processed and waiting for approve.
